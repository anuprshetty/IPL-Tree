...
--
-- Host: 127.0.0.1    Database: normalized_ipl_tree
-- ------------------------------------------------------
...
--
-- Table structure for table `player_1nf`
--

DROP TABLE IF EXISTS `player_1nf`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `player_1nf` (
  `p_id` varchar(7) NOT NULL,
  `Player_name` varchar(25) NOT NULL,
  `age` int NOT NULL,
  `nationality` varchar(20) NOT NULL,
  ...
  `bidamt` decimal(5,2) DEFAULT NULL,
  `t_id` varchar(7) NOT NULL,
  PRIMARY KEY (`p_id`,`role`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `player_1nf`
--

LOCK TABLES `player_1nf` WRITE;
/*!40000 ALTER TABLE `player_1nf` DISABLE KEYS */;
INSERT INTO `player_1nf` VALUES ('PA001','Virat Kohli',28,'Indian','batsman',72.10,'RCB'),('PA001','Virat Kohli',28,'Indian','captain',72.10,'RCB'),('PA004','AB De Villiers',30,'South Africa','batsman',63.00,'RCB'),('PA004','AB De Villiers',30,'South Africa','keeper',63.00,'RCB'),('PB001','M S Dhoni',28,'Indian','batsman',54.30,'CSK'),('PB001','M S Dhoni',28,'Indian','keeper',54.30,'CSK'),('PB003','Lasith Malinga',37,'Sri Lanka','bowler',64.60,'CSK'),('PB003','Lasith Malinga',37,'Sri Lanka','captain',64.60,'CSK'),('PC001','Ravichandran Ashwin',33,'Indian','bowler',32.10,'HYD'),('PC001','Ravichandran Ashwin',33,'Indian','captain',32.10,'HYD'),('PC002','Angelo Mathews',21,'Sri Lanka','batsman',65.00,'HYD'),('PC002','Angelo Mathews',21,'Sri Lanka','vice-captain',65.00,'HYD'),('PD003','Tilakaratne Dilshan',32,'Sri Lanka','bowler',89.00,'MI'),('PD003','Tilakaratne Dilshan',32,'Sri Lanka','keeper',89.00,'MI'),('PD004','Dale Steyn',34,'South African','batsman',62.19,'MI'),('PD004','Dale Steyn',34,'South African','bowler',62.19,'MI'),('PE001','Dinesh Chandimal',29,'Sri Lanka','bowler',54.00,'KKR'),('PE001','Dinesh Chandimal',29,'Sri Lanka','captain',54.00,'KKR'),('PE002','JP Dumminy',27,'South African','batsman',76.00,'KKR'),('PE002','JP Dumminy',27,'South African','vice-captain',76.00,'KKR'),('PF002','Mitchell Starc',38,'England','bowler',31.00,'DD'),('PF002','Mitchell Starc',38,'England','vice-captain',31.00,'DD'),('PF004','Upul Tharanga',28,'Sri Lanka','batsman',60.00,'DD'),('PF004','Upul Tharanga',28,'Sri Lanka','bowler',60.00,'DD'),('PG001','Rohith Sharma',29,'Indian','batsman',52.00,'RR'),('PG001','Rohith Sharma',29,'Indian','captain',52.00,'RR'),('PG003','Hashim Amla',31,'South Africa','bowler',73.25,'RR'),('PG003','Hashim Amla',31,'South Africa','keeper',73.25,'RR'),('PH001','Goutham Gambhir',25,'Indian','bowler',64.34,'KXIP'),('PH001','Goutham Gambhir',25,'Indian','captain',64.34,'KXIP'),('PH004','Imran Tahir',28,'South Africa','batsman',64.23,'KXIP'),('PH004','Imran Tahir',28,'South Africa','bowler',64.23,'KXIP');
/*!40000 ALTER TABLE `player_1nf` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `player_n3nf`
--

DROP TABLE IF EXISTS `player_n3nf`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `player_n3nf` (
  `player_name` varchar(25) NOT NULL,
  `age` int NOT NULL,
  `nationality` varchar(20) NOT NULL,
...
--
-- Dumping data for table `player_n3nf`
--

LOCK TABLES `player_n3nf` WRITE;
/*!40000 ALTER TABLE `player_n3nf` DISABLE KEYS */;
INSERT INTO `player_n3nf` VALUES ('AB De Villiers',30,'South Africa'),('Angelo Mathews',21,'Sri Lanka'),('Dale Steyn',34,'South African'),('Dinesh Chandimal',29,'Sri Lanka'),('Goutham Gambhir',25,'Indian'),('Hashim Amla',31,'South Africa'),('Imran Tahir',28,'South Africa'),('JP Dumminy',27,'South African'),('Lasith Malinga',37,'Sri Lanka'),('M S Dhoni',28,'Indian'),('Mitchell Starc',38,'England'),('Ravichandran Ashwin',33,'Indian'),('Rohith Sharma',29,'Indian'),('Tilakaratne Dilshan',32,'Sri Lanka'),('Upul Tharanga',28,'Sri Lanka'),('Virat Kohli',28,'Indian');
/*!40000 ALTER TABLE `player_n3nf` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `player_p2nf`
--

DROP TABLE IF EXISTS `player_p2nf`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `player_p2nf` (
  `p_id` varchar(7) NOT NULL,
  `Player_name` varchar(25) NOT NULL,
  `age` int NOT NULL,
  `nationality` varchar(20) NOT NULL,
...
--
-- Dumping data for table `player_p2nf`
--

LOCK TABLES `player_p2nf` WRITE;
/*!40000 ALTER TABLE `player_p2nf` DISABLE KEYS */;
INSERT INTO `player_p2nf` VALUES ('PA001','Virat Kohli',28,'Indian',72.10,'RCB'),('PA004','AB De Villiers',30,'South Africa',63.00,'RCB'),('PB001','M S Dhoni',28,'Indian',54.30,'CSK'),('PB003','Lasith Malinga',37,'Sri Lanka',64.60,'CSK'),('PC001','Ravichandran Ashwin',33,'Indian',32.10,'HYD'),('PC002','Angelo Mathews',21,'Sri Lanka',65.00,'HYD'),('PD003','Tilakaratne Dilshan',32,'Sri Lanka',89.00,'MI'),('PD004','Dale Steyn',34,'South African',62.19,'MI'),('PE001','Dinesh Chandimal',29,'Sri Lanka',54.00,'KKR'),('PE002','JP Dumminy',27,'South African',76.00,'KKR'),('PF002','Mitchell Starc',38,'England',31.00,'DD'),('PF004','Upul Tharanga',28,'Sri Lanka',60.00,'DD'),('PG001','Rohith Sharma',29,'Indian',52.00,'RR'),('PG003','Hashim Amla',31,'South Africa',73.25,'RR'),('PH001','Goutham Gambhir',25,'Indian',64.34,'KXIP'),('PH004','Imran Tahir',28,'South Africa',64.23,'KXIP');
/*!40000 ALTER TABLE `player_p2nf` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `player_p3nf`
--

DROP TABLE IF EXISTS `player_p3nf`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `player_p3nf` (
  `p_id` varchar(7) NOT NULL,
  `Player_name` varchar(25) NOT NULL,
  `bidamt` decimal(5,2) DEFAULT NULL,
  `t_id` varchar(7) NOT NULL,
...
--
-- Dumping data for table `player_p3nf`
--

LOCK TABLES `player_p3nf` WRITE;
/*!40000 ALTER TABLE `player_p3nf` DISABLE KEYS */;
INSERT INTO `player_p3nf` VALUES ('PA001','Virat Kohli',72.10,'RCB'),('PA004','AB De Villiers',63.00,'RCB'),('PB001','M S Dhoni',54.30,'CSK'),('PB003','Lasith Malinga',64.60,'CSK'),('PC001','Ravichandran Ashwin',32.10,'HYD'),('PC002','Angelo Mathews',65.00,'HYD'),('PD003','Tilakaratne Dilshan',89.00,'MI'),('PD004','Dale Steyn',62.19,'MI'),('PE001','Dinesh Chandimal',54.00,'KKR'),('PE002','JP Dumminy',76.00,'KKR'),('PF002','Mitchell Starc',31.00,'DD'),('PF004','Upul Tharanga',60.00,'DD'),('PG001','Rohith Sharma',52.00,'RR'),('PG003','Hashim Amla',73.25,'RR'),('PH001','Goutham Gambhir',64.34,'KXIP'),('PH004','Imran Tahir',64.23,'KXIP');
/*!40000 ALTER TABLE `player_p3nf` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `player_r2nf`
--

DROP TABLE IF EXISTS `player_r2nf`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `player_r2nf` (
...
--
-- Dumping data for table `player_r2nf`
--

LOCK TABLES `player_r2nf` WRITE;
/*!40000 ALTER TABLE `player_r2nf` DISABLE KEYS */;
INSERT INTO `player_r2nf` VALUES ('PA001','batsman'),('PA001','captain'),('PA004','batsman'),('PA004','keeper'),('PB001','batsman'),('PB001','keeper'),('PB003','bowler'),('PB003','captain'),('PC001','bowler'),('PC001','captain'),('PC002','batsman'),('PC002','vice-captain'),('PD003','bowler'),('PD003','keeper'),('PD004','batsman'),('PD004','bowler'),('PE001','bowler'),('PE001','captain'),('PE002','batsman'),('PE002','vice-captain'),('PF002','bowler'),('PF002','vice-captain'),('PF004','batsman'),('PF004','bowler'),('PG001','batsman'),('PG001','captain'),('PG003','bowler'),('PG003','keeper'),('PH001','bowler'),('PH001','captain'),('PH004','batsman'),('PH004','bowler');
/*!40000 ALTER TABLE `player_r2nf` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-04-23 21:36:09
